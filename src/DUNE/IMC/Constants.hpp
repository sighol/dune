...
#define DUNE_IMC_CONST_GIT_INFO "2015-05-07 f2cc90b  (HEAD, origin/ntnu-remus, origin/HEAD, ntnu-remus)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "30fb744948c3ce8801f71389a532fa9a"
